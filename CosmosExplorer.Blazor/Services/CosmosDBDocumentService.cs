...
public class CosmosDBDocumentService
{
    ...
    public CosmosDBDocumentService(StateContainer stateContainer, IConnectionService connectionService, IQueryService queryService, ICommandService commandService)
	{
    ...
    public async Task<string> ChangeContainerAsync(string databaseName, string containerName)
    {
        ...
        return await connectionService.ChangeContainerAsync(stateContainer.ConnectionString,databaseName, containerName);  
	}
